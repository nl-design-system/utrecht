...
### 4.3 Product Dienst Status Component
...
#### 5.1.1 Combinatie van notificaties en status pagina
...
![Email screenshot](../../../static/img/pds_email.png)

#### 5.2.1 Next steps duidelijk na het lezen van de e-mail
...
#### 5.3.5 Navigeren naar het de zaak
...
#### 5.4.1 Product Dienst Status component wordt als optimaal ervaren

Combinatie zelf status opzoeken en  notificaties ontvangen wordt als optimaal gezien door de geinterviewden

#### 5.4.2 Afspraak weijzigen
...
#### 5.4.3 Eerst de status tonen, dan pas de key info
...
## 6. Wat is er mee gedaan?

- De resultaten van dit onderzoek zijn doorgegeven aan de Designers van de gemeente Den Haag om het Product Dienst Status component te verbeteren.