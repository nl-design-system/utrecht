...
| Beschrijving           | Design Token                        | Opmerking                                                 |
| ---------------------- | ----------------------------------- | --------------------------------------------------------- |
| Extra Small (1 / 100%) | --utrecht-typography-line-height-xs |                                                           |
| Small (1.25 / 125%)    | --utrecht-typography-line-height-sm |                                                           |
| Medium (1.5 / 150%)    | --utrecht-typography-line-height-md | Standaard gebruiken we bij alle teksten deze line height. |
| Large (2 / 200%)       | --utrecht-typography-line-height-lg |                                                           |
