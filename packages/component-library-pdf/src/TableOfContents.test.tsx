...
describe('Nested Table of Contents', () => {
  let sha256: string;

  beforeAll(async () => {
    ({ sha256 } = await renderPdf({
      id: 'pdf-table-of-contents-nested',
      render: () => (
        <>
          <Heading1>Document Title</Heading1>
          <TableOfContents>
            ...
            <TableOfContentsList>
              <TableOfContentsListItem>
                ...
                <TableOfContentsList>
                  <TableOfContentsListItem>
                    <TableOfContentsLink href="#chapter-1-1" label="1.1. ">
                      The quick brown fox jumps over the lazy dog
                    </TableOfContentsLink>
                  </TableOfContentsListItem>
                </TableOfContentsList>
          ...
          <Heading2 id="chapter-1">The quick brown fox jumps over the lazy dog</Heading2>
          <Heading3 id="chapter-1-1">The quick brown fox jumps over the lazy dog</Heading3>
        </>
      ),
    }));
  });
