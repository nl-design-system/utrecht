...
## Hoe draai ik astro lokaal?

1. Zorg dat je de dependencies hebt geïnstalleerd met `pnpm install`
2. Bouw de benodigde dependencies met `pnpm build`
3. Voer vanaf de root van het project `pnpm astro` uit
