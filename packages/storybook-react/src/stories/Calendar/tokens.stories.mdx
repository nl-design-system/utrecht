...
<Meta
  id="react-calendar--design-tokens"
  title="React.js Component/Calendar/Design Tokens"
  parameters={{
    status: {
      type: "ALPHA",
    },
...
<ComponentTokensSection tokens={tokens} definition={tokensDefinition} component="utrecht-calendar" />
