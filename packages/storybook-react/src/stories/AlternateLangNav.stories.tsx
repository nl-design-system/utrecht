...
import readme from '@utrecht/components/alternate-lang-nav/README.md';
...
const ButtonGroupTemplate: StoryObj<typeof LinkButton> = () => {
  const args = {
    heading: 'Taal kiezen',
    headingId: '0103ec04-5ef6-41e6-b5f7-2fa7f60b0ed9',
    headingLevel: 2,
...
export const ButtonGroupStory = ButtonGroupTemplate.bind({});
