...
import KTO from '../prototype-src/webpaginablokken/KTO.js'; // Importeer het scenario-component
import '../styles.css';
          ...
          <main>
            <section>
              ...
              <Paragraph appearance="lead">
                We werken aan een andere inrichting van de Amsterdamsestraatweg tussen Weerdsingel en de Marnixlaan. En
                we vervangen het riool. We willen de verkeersveiligheid verbeteren voor fiets en voetganger, en de
              ...
              <Paragraph>
                ...
                opnieuw af voor autoverkeer. We zetten dan daar de strepen en patronen op het asfalt. Zodra een stuk weg
                klaar is gaat het weer open. Ook in het weekend van 5 en 6 juli is de Amsterdamsestraatweg open voor
                auto&apos;s in beide richtingen.
              </Paragraph>
              <Paragraph>
                Op maandagavond 7 juli zijn we klaar met de werkzaamheden. Dan is de Amsterdamsestraatweg weer helemaal
                open voor autoverkeer in 2 richtingen.
              </Paragraph>
              ...
              <Paragraph>
                Reis &apos;s ochtends voor 7.30 uur of na 9.00 uur en ‘s middags voor 16.00 uur en na 18.00 uur. Dan is
              ...
              <Paragraph>
                Samen met bewoners en ondernemers werkten we aan een ontwerp voor de nieuwe inrichting. De straat wordt
                veiliger, groener en mooier. Er is meer ruimte voor fietsers, voetgangers en terrassen. De straat kan
                straks beter tegen grote wisselingen in het klimaat, zoals warme zomers en veel regen.
              </Paragraph>
              {/* TODO: add content to Accordion AccordionProvider*/}
              <AccordionProvider
                sections={[
                  {
              ...
              <Paragraph>
                Tijdens de werkzaamheden houden we u op de hoogte via de BouwApp. Hier vindt u informatie over het werk
                en de omleidingen. U kunt ook vragen stellen. Download de app via de Apple Appstore of Android
