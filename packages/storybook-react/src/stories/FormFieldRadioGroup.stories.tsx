...
const meta = {
  title: 'React Component/Form Field/Radio group',
  ...
  render: (args) => {
    const { groupDescription, groupId, groupInvalidDescription, groupLabel, headingLevel, invalid, options, name } =
      args;
...
export const FormFieldRadioGroup: Story = {};
