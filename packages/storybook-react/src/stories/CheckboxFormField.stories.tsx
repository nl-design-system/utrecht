...
import { Checkbox, CheckboxFormField } from '@utrecht/component-library-react';
...
const meta = {
  title: 'React Component/Checkbox Form Field',
  id: 'react-checkbox-form-field',
...
} as Meta<typeof CheckboxFormField>;

export default meta;

type Story = StoryObj<typeof CheckboxFormField>;
const inputId = `utrecht-checkbox-A872061E-215F-41AA-8B5E-CCFD769F9775`;
const Template: Story = {
  render: (args) => {
    ...
    return (
      ...
      >
        <Checkbox id={inputId} aria-describedby={ariaDescribedby} disabled={args.label?.disabled} />
      </CheckboxFormField>
    );
  },
};
