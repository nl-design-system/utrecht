...
<Meta
  id="react-accordion--design-tokens"
  title="React Component/Accordion/Design Tokens"
  parameters={{
    status: {
      type: "ALPHA",
    },
...
<ComponentTokensSection tokens={tokens} definition={tokensDefinition} component="utrecht-accordion" />
