...
import { Textarea, TextareaFormField } from '@utrecht/component-library-react';
...
const meta = {
  title: 'React Component/Textarea Form Field',
  id: 'react-textarea-form-field',
...
} as Meta<typeof TextareaFormField>;

export default meta;

type Story = StoryObj<typeof TextareaFormField>;
const inputId = `utrecht-textarea-A872061E-215F-41AA-8B5E-CCFD769F9775`;
const Template: Story = {
  render: (args) => {
    ...
    return (
      ...
      >
        <Textarea id={inputId} aria-describedby={ariaDescribedby} disabled={args.label?.disabled} />
      </TextareaFormField>
    );
  },
};
