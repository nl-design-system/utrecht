...
import { Select, SelectFormField, SelectOption } from '@utrecht/component-library-react';
...
const meta = {
  title: 'React Component/Select Form Field',
  id: 'react-select-form-field',
...
} as Meta<typeof SelectFormField>;

export default meta;

type Story = StoryObj<typeof SelectFormField>;
const inputId = `utrecht-select-A872061E-215F-41AA-8B5E-CCFD769F9775`;
const Template: Story = {
  render: (args) => {
    ...
    return (
      ...
      >
        <Select id={inputId} aria-describedby={ariaDescribedby} disabled={args.label?.disabled}>
