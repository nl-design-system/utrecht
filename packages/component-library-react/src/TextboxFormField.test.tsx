...
describe('Form field with textbox', () => {
  ...
  it('renders an HTML input element', () => {
    const { container } = render(<TextboxFormField />);
  ...
  /* TODO: textbox test too */
  it('can render a name attribute for server-side submission', () => {
    const { container } = render(<TextboxFormField name="query" />);

    const textbox = container.querySelector('input[name="query"]');
  ...
  it('displays as CSS block element', () => {
    ...
    expect(textbox).toHaveStyle({ display: 'block' });
  });
  ...
  it('renders a design system BEM block class name', () => {
    ...
    expect(textbox).toHaveClass('utrecht-form-field');
    expect(textbox).toHaveClass('utrecht-form-field--text');
  });

  describe('disabled variant', () => {
    it.skip('can have a disabled state', () => {
    ...
    it.skip('is not disabled by default', () => {
      const { container } = render(<Textbox />);
    ...
    it.skip('renders a design system BEM modifier class name', () => {
      const { container } = render(<Textbox disabled />);
    ...
    it.skip('omits non-essential disabled attributes when not disabled', () => {
    ...
    it.skip('can have a disabled state in CSS', () => {
      const { container } = render(<Textbox disabled />);
  ...
  describe('invalid variant', () => {
    it.skip('can have an invalid state', () => {
    ...
    it.skip('is not invalid by default', () => {
      const { container } = render(<Textbox />);
    ...
    it.skip('omits non-essential invalid attributes when not invalid', () => {
  ...
  describe('read-only variant', () => {
    ...
    it.skip('omits non-essential read-only attributes when not read-only', () => {
      const handleChange = () => {};
    ...
    it.skip('can have a read-only state in CSS', () => {
      const handleChange = () => {};
      const { container } = render(<Textbox readOnly onChange={handleChange} />);
  ...
  describe('required variant', () => {
    it.skip('can have a required state', () => {
    ...
    it.skip('omits non-essential required attributes when not required', () => {
    ...
    it.skip('can have a required state in CSS', () => {
      const { container } = render(<Textbox required />);
  ...
  describe('variant for URL values', () => {
    it.skip('renders an HTML input type=url element that can trigger the URL input mode', () => {
  ...
  describe('variant for email values', () => {
    it.skip('renders an HTML input type=email element that can trigger the email input mode', () => {
  ...
  describe('variant for password values', () => {
    it.skip('renders an HTML input type=password element that masks input', () => {
  ...
  describe('variant for telephone values', () => {
    it.skip('renders an HTML input type=tel element that can trigger the telephone number input mode', () => {
  ...
  describe('variant for numeric values', () => {
    it.skip('renders an HTML inputMode attribute that can trigger the numeric input mode', () => {
  ...
  it.skip('can have a custom class name', () => {
  ...
  it.skip('can have a additional class name', () => {
  ...
  it.skip('can limit the input length in a way that prevents screen reader from announcing blocked typed input', () => {
  ...
  describe('change event', () => {
    it.skip('can trigger a change event', async () => {
  ...
  describe('input event', () => {
    it('can trigger a change event', async () => {
      ...
      render(<TextboxFormField onInput={handleInput} defaultValue="Hello" />);
  ...
  it('supports ForwardRef in React for the form control', () => {
    const ref = createRef<HTMLInputElement>();

    const { container } = render(<TextboxFormField ref={ref} />);
