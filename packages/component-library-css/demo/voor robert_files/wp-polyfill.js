...
*/
          ...
          { target: 'String', proto: true, forced: TO_STRING_CONVERSION_BUG },
          {
            toWellFormed: function toWellFormed() {
              ...
              for (var i = 0; i < length; i++) {
                ...
                // unpaired surrogate
                else if (charCode >= 0xdc00 || i + 1 >= length || (charCodeAt(S, i + 1) & 0xfc00) != 0xdc00)
                  ...
                  try {
                    Promise.resolve(anObject(call(next, iterator))).then(function (step) {
                      try {
                        if (anObject(step).done) {
                          noInitial
                            ? reject($TypeError('Reduce of empty iterator with no initial value'))
                            : resolve(accumulator);
                        } else {
                          var value = step.value;
                          if (noInitial) {
          ...
          { target: 'Iterator', proto: true, real: true },
          {
            toAsync: function toAsync() {
              return new WrapAsyncIterator(
                getIteratorDirect(new AsyncFromSyncIterator(getIteratorDirect(anObject(this)))),
              );
            },
          },
        );
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        exportTypedArrayStaticMethod(
          'fromAsync',
          function fromAsync(asyncItems /* , mapfn = undefined, thisArg = undefined */) {
            var C = this;
            var argumentsLength = arguments.length;
            var mapfn = argumentsLength > 1 ? arguments[1] : undefined;
            var thisArg = argumentsLength > 2 ? arguments[2] : undefined;
      ...
      /***/ function (module, exports, __webpack_require__) {
        ...
        module.exports = !fails(function () {
          ...
          return (
            (IS_PURE && (!url.toJSON || !searchParams2.has('a', 1) || searchParams2.has('a', 2))) ||
