            ...
            ((r = l[i]).search_match = !1),
              ...
              this.include_option_in_results(r) &&
                ...
                null != r.group_array_index &&
                  ...
                  (0 === (a = this.results_data[r.group_array_index]).active_options && a.search_match && (_ += 1),
                  (a.active_options += 1)),
                ...
                (r.group && !this.group_search) ||
                  ...
                  r.search_match
                    ? (h.length &&
                        ...
                        (r.highlighted_html =
                          this.escape_html(o) + '<em>' + this.escape_html(s) + '</em>' + this.escape_html(p))),
    ...
    (s = (function (s) {
      ...
      return (
        ...
        (n.prototype.setup = function () {
          return (
            (this.form_field_jq = t(this.form_field)), (this.current_selectedIndex = this.form_field.selectedIndex)
          );
        }),
        ...
        (n.prototype.search_results_mouseup = function (e) {
          var s;
          if (
            (s = t(e.target).hasClass('active-result') ? t(e.target) : t(e.target).parents('.active-result').first())
              .length
          )
