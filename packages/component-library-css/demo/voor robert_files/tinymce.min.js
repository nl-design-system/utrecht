...
!(function (V) {
  ...
  (m = /Android/.test(se)),
    (a =
      ...
      /MSIE (\w+)\./.exec(se)[1]),
    (u = -1 !== se.indexOf('Trident/') && (-1 !== se.indexOf('rv:') || -1 !== ue.appName.indexOf('Netscape')) && 11),
    (s = -1 !== se.indexOf('Edge/') && !a && !u && 12),
    (a = a || u || s),
    (c = !i && !u && /Gecko/.test(se)),
    (l = -1 !== se.indexOf('Mac')),
    (f = /(iPad|iPhone)/.test(se)),
    (g = 'FormData' in V.window && 'FileReader' in V.window && 'URL' in V.window && !!ae.createObjectURL),
    ...
    Ne = function (e, t) {
      ...
      return (
        ...
        !(o.stopImmediatePropagation = function () {
          ...
          ((o.isDefaultPrevented = be), (o.isPropagationStopped = be), (o.isImmediatePropagationStopped = be)),
    ...
    Se = function () {
      ...
      (y.bind = function (e, t, n, r) {
        ...
        if (e && 3 !== e.nodeType && 8 !== e.nodeType) {
          for (
            e[g] ? (o = e[g]) : ((o = m++), (e[g] = o), (b[o] = {})), r = r || e, a = (t = t.split(' ')).length;
            a--;
                ...
                : (h ||
                    ((s = v[u]) &&
                      (c = function (e) {
                        ...
                        n ||
                          (((e = Ne(e || f.event)).type = 'mouseout' === e.type ? 'mouseleave' : 'mouseenter'),
                          (e.target = t),
                          C(e, o));
                      })),
                  p ||
    ...
    if (Ue && !r) {
      if ((o = Ct.exec(e)))
        if ((a = o[1])) {
          ...
          } else if (t.ownerDocument && (i = t.ownerDocument.getElementById(a)) && He(t, i) && i.id === a)
            return n.push(i), n;
        } else {
          ...
          (Je = t
            ...
            : function (e, t) {
                ...
                var n,
                  ...
                  u = [t];
                if (!o || !i)
                  return e === s ? -1 : t === s ? 1 : o ? -1 : i ? 1 : Ie ? it.call(Ie, e) - it.call(Ie, t) : 0;
    ...
    for (
      ...
      if ((t = _e.relative[e[u].type])) l = [It(Lt(l), t)];
        ...
        if ((t = _e.filter[e[u].type].apply(null, e[u].matches))[qe]) {
          ...
          return Mt(
            1 < u && Lt(l),
            1 < u && Pt(e.slice(0, u - 1).concat({ value: ' ' === e[u - 2].type ? '*' : '' })).replace(lt, '$1'),
            t,
            u < n && zt(e.slice(u, n)),
            n < o && zt((e = e.slice(n))),
            n < o && Pt(e),
    ...
    (De = St.tokenize =
      function (e, t) {
        ...
        for (a = e, u = [], s = _e.preFilter; a; ) {
          for (i in ((n && !(r = ft.exec(a))) || (r && (a = a.slice(r[0].length) || a), u.push((o = []))),
          (n = !1),
          (r = dt.exec(a)) &&
            ((n = r.shift()), o.push({ value: n, type: r[0].replace(lt, ' ') }), (a = a.slice(n.length))),
          _e.filter))
            !(r = ht[i].exec(a)) ||
              (s[i] && !(r = s[i](r))) ||
  ...
  (gn.fn = gn.prototype =
    {
      ...
      add: function (e, t) {
        ...
        if (!1 !== t)
          for (n = gn.unique(o.toArray().concat(gn.makeArray(e))), o.length = n.length, r = 0; r < n.length; r++)
            o[r] = n[r];
    ...
    function (e, r) {
      gn.fn[e] = function (t) {
        ...
        return (
          ...
          1 < this.length && (en[e] || (n = gn.unique(n)), 0 === e.indexOf('parents') && (n = n.reverse())),
          (n = gn(n)),
          t ? n.filter(t) : n
        );
      };
      ...
      function (r, o) {
        gn.fn[r] = function (t, e) {
          ...
          return (
            ...
            1 < this.length &&
              ((n = gn.unique(n)), (0 !== r.indexOf('parents') && 'prevUntil' !== r) || (n = n.reverse())),
            (n = gn(n)),
            e ? n.filter(e) : n
          );
        };
    ...
    Tr = function (e, t) {
      ...
      hr(t, function (e, t) {
        !(function (e, t, n) {
          if (!S(n))
            throw (
              (V.console.error('Invalid call to CSS.set. Property ', t, ':: Value ', n, ':: Element ', e),
      ...
      decode: function (e) {
        return e.replace(Yo, function (e, t) {
          return t
            ...
            : vo[e] ||
                po[e] ||
                ((n = e), ((r = ar.fromTag('div').dom()).innerHTML = n), r.textContent || r.innerText || n);
          var n, r;
        });
      },
    },
      ...
      var u,
        ...
        a = function (e, t, n) {
          ...
          for (t = t || '', 'string' == typeof (n = n || []) && (n = ci(n)), r = (e = ci(e)).length; r--; )
            (i = { attributes: a((o = ci([u, t].join(' ')))), attributesOrder: o, children: a(n, ri) }), (s[e[r]] = i);
        },
        c = function (e, t) {
          var n, r, o, i;
      ...
      v = function (e, t, n) {
        ...
        return (
          r
            ...
            : (r = ni[e]) || ((r = oi(t, ' ', oi(t.toUpperCase(), ' '))), (r = ai(r, n)), (ni[e] = r)),
          r
        );
      };
    (n = li((i = i || {}).schema)),
      ...
      ii((i.special || 'script noscript iframe noframes noembed title style textarea xmp').split(' '), function (e) {
        h[e] = new RegExp('</' + e + '[^>]*>', 'gi');
      });
    var S = function (e) {
      ...
      y = function (e) {
        ...
        if (e)
          for (
            e = ci(e, ','), N['@'] && ((h = N['@'].attributes), (v = N['@'].attributesOrder)), t = 0, n = e.length;
            t < n;
            t++
          )
            if ((i = C.exec(e[t]))) {
    ...
    var r = {},
                ...
                if (3 !== a.status) {
                  if (
                    ...
                    if (0 < V.navigator.userAgent.indexOf('Firefox'))
                      return ((r = m.createElement('style')).textContent = '@import "' + e + '"'), f(), void y(r);
                    l();
                  }
                  var d;
                  y(o), (o.href = e);
      ...
      R = function (e, n, r, o, i) {
        return k(e, function (e) {
          ...
          return (
            _(t, r),
            o && ('string' != typeof o && o.nodeType ? t.appendChild(o) : 'string' == typeof o && A(t, o)),
            i ? t : e.appendChild(t)
          );
        });
      },
          ...
          j === Ei.DOM || a !== V.document
            ? (e || (e = ''),
              ...
              hi(e.split(','), function (e) {
                var t;
                (e = Xt._addCacheSuffix(e)),
                  o[e] || ((o[e] = !0), (t = D('link', { rel: 'stylesheet', href: e })), n.appendChild(t));
              }))
            : Ei.DOM.loadCSS(e);
        },
                  ...
                  2 !== l[e]
                    ? 3 !== l[e]
                      ? 1 !== l[e] &&
                        ...
                        (V.document.getElementsByTagName('head')[0] || V.document.body).appendChild(o))
                      : c('failure', e)
                    : c('success', e);
                }),
                !f)
  ...
  var Pi = function (t, n) {
    ...
    Qi = function (e, t) {
      return (
        (n = t), (o = (r = e) === undefined ? V.document : r.dom()), Fr(o) ? [] : W(o.querySelectorAll(n), ar.fromDom)
      );
      var n, r, o;
    };
  ...
  var ea,
    ...
    Eu = function (e) {
      ...
      if (uu(e.container()))
        if (e.isAtEnd())
          (n = hu(e.container(), e.offset())), mu(n) && i(n, n.data.length), fu(n) && !gu(n) && o(Nu(wu(n), !1));
        else {
    ...
    Yu = {
      getBookmark: function (e, t, n) {
        return 2 === t
          ...
          : 3 === t
          ? ((o = (r = e).getRng()),
            { start: Lu(r.dom.getRoot(), _u.fromRangeStart(o)), end: Lu(r.dom.getRoot(), _u.fromRangeEnd(o)) })
          : t
          ? { rng: e.getRng() }
          : Xu(e, !1);
        var r, o;
          ...
          !(function (e) {
            ...
            for (t = gn('*[contentEditable=false]', e), o = 0; o < t.length; o++)
              (r = (n = t[o]).previousSibling),
                Ba(r) && (1 === (i = r.data).length ? r.parentNode.removeChild(r) : r.deleteData(i.length - 1, 1)),
                (r = n.nextSibling),
        ...
        show: function (t, e) {
          ...
          if (!u(e))
            return (
              ...
              ls(s.nextSibling) ? (r.setStart(s, 0), r.setEnd(s, 0)) : (r.setStart(s, 1), r.setEnd(s, 1)),
              r
            );
  ...
  var Ms,
    ...
    Gs = function (e, t, n) {
      ...
      if (Vs(f)) {
        ...
        if (xs(e) && d < f.childNodes.length && ((o = Xs(f, d)), $s(o)))
          return qs(o)
            ? ((s = n),
              (l = (c = o).nextSibling) && $s(l) ? (Vs(l) ? _u(l, 0) : _u.before(l)) : Gs(Tu.Forwards, _u.after(c), s))
            : !Ws(o) && (i = Es(o, e, Ks, o))
            ? Vs(i)
              ? _u(i, 0)
              : _u.before(i)
      ...
      return ((xs(e) && u.isAtEnd()) || (ws(e) && u.isAtStart())) && ((r = Es(r, e, q(!0), n, !0)), Ks(r, n))
        ? Ys(e, r)
        : ((o = Es(r, e, Ks, n)),
          !(a = Ht.last(
            U(
    ...
    cc = function (e, t) {
      return (
        jo.isElement(t) && e.isBlock(t) && !t.innerHTML && !fe.ie && (t.innerHTML = '<br data-mce-bogus="1" />'), t
      );
    },
    lc = function (e, t) {
    ...
    fc = function (e, t, n) {
      return !(
        !1 !== t.hasChildNodes() ||
        !Qu(e, t) ||
        ((o = n), (i = (r = t).ownerDocument.createTextNode(xa)), r.appendChild(i), o.setStart(i, 0), o.setEnd(i, 0), 0)
      );
      var r, o, i;
    },
    dc = function (e, t, n, r) {
    ...
    pc = function (e, t) {
      ...
      if (t) {
        if (((v = t), Xt.isArray(v.start)))
          return (p = t), (h = (g = y).createRng()), dc(g, !0, p, h) && dc(g, !1, p, h) ? _.some(h) : _.none();
    ...
    wc = {
      ...
      moveStart: function (e, t, n) {
        var r,
          ...
          u = n.startContainer;
        if (
          (n.startContainer !== n.endContainer || !bc(n.startContainer.childNodes[n.startOffset])) &&
          1 === u.nodeType
        )
          for (
    ...
    Ac = function (e, t, n, r) {
      ...
      return (
        ...
        e
          ? ((o = a.lastIndexOf(' ', r)),
            -1 !== (o = (i = a.lastIndexOf('\xa0', r)) < o ? o : i) && !t && (o < r || !e) && o <= a.length && o++)
    ...
    Bc = function (e, t, n, r, o, i, a) {
      ...
      for (;;) {
        ...
        for (c = s[l]; c; c = c[l])
          if (!Nc(c) && !Sc(c) && ('BR' !== (d = c).nodeName || !d.getAttribute('data-mce-bogus') || d.nextSibling))
            return s;
    ...
    Pc = function (e, t, n, r) {
      ...
      return (
        ...
        (n[0].inline || n[0].block_expand) &&
          ...
          (n[0].inline && 3 === u.nodeType && s !== u.nodeValue.length) || (u = Bc(c, n, i, a, u, s, !1))),
        n[0].selector &&
          !1 !== n[0].expand &&
          !n[0].inline &&
        ...
        (n[0].block || n[0].selector) &&
          ...
          n[0].block &&
            (c.isBlock(i) || (i = Bc(c, n, i, a, u, s, !0)), c.isBlock(u) || (u = Bc(c, n, i, a, u, s, !1)))),
  ...
  var ul,
    ...
    dl = function (e, t, n) {
      ...
      if (
          ...
          g.isCollapsed() ||
            ...
            3 === C.nodeType &&
              ...
              ('\xa0' === C.data[x]
                ...
                : '\xa0' === C.data[x - 1] && (C.deleteData(x - 1, 1), /[\u00a0| ]$/.test(b) || (b = ' ' + b))),
            (t = b));
        var E,
          S,
          T,
        ...
        if (((u = r.parse(t, k)), !0 === n.paste && Gc(e.schema, u) && Qc(p, i)))
          return (l = Jc(o, p, e.selection.getRng(), u)), e.selection.setRng(l), void e.fire('SetContent', s);
        if (
          ((function (e) {
    ...
    ml = function (e, t) {
      var n,
        ...
        o =
          'string' != typeof (n = t)
            ? ((r = Xt.extend({ paste: n.paste, data: { paste: n.paste } }, n)), { content: n.content, details: r })
            : { content: n, details: {} };
    ...
    bf = function (e) {
      ...
      return yf(i, a)
        ...
        : ((n = i),
          (r = e.selection),
          (o = r.getRng()),
          ru(Hl(n, ar.fromDom(o.startContainer)), Hl(n, ar.fromDom(o.endContainer)), function (e, t) {
            return (
              !1 === Mr(e, t) &&
              (o.deleteContents(),
    ...
    Gd = function (r, o, i, a) {
      ...
      r.undoManager.ignore(function () {
        ...
        r.selection.setRng(
          ...
          Ld(s, u, _u.fromRangeStart(r.selection.getRng())).map(zd).map(Yd(r, o));
      }),
        r.nodeChanged();
    },
    Jd = function (n, r, i, o) {
    ...
    Mm = {
      ...
      match: function (e, t, n, r) {
        ...
        return r
          ? Pm(e, r, t, n)
          : ((r = e.selection.getNode()), !!Pm(e, r, t, n) || !((o = e.selection.getStart()) === r || !Pm(e, o, t, n)));
      },
      ...
      return (
        t === r && jo.isText(t)
          ? 0 < n &&
            ...
            n < o ? ((t = r = zm(r, (o -= n)).previousSibling), (o = r.nodeValue.length), (n = 0)) : (o = 0))
          : (jo.isText(t) && 0 < n && n < t.nodeValue.length && ((t = zm(t, n)), (n = 0)),
            jo.isText(r) && 0 < o && o < r.nodeValue.length && (o = (r = zm(r, o).previousSibling).nodeValue.length)),
    ...
    Jm = function (i) {
      i.on('mouseup keydown', function (e) {
        ...
        (t = i),
          ...
          (o = t.getBody()),
          Km(t, null, !1),
          (8 !== n && 46 !== n) || !r.isCollapsed() || r.getStart().innerHTML !== jm || Km(t, Qu(o, r.getStart())),
    ...
    wg = function (o) {
      return _.from(o.selection.getRng()).bind(function (e) {
        var t,
          ...
          r = o.getBody();
        return (
          (n = r), (t = e).startContainer === n && 0 === t.startOffset ? _.none() : _.from(o.selection.getStart(!0))
        );
      });
    },
    Ng = function (e, t) {
    ...
    Rg = function (e, t, n, r) {
      ...
      if (
        ...
        return _.none();
      if (
        (jo.isElement(o) && i > o.childNodes.length - 1 && (c = !1), jo.isDocument(o) && ((o = g), (i = 0)), o === g)
      ) {
      ...
      'InsertUnorderedList,InsertOrderedList': function (e) {
        ...
        l(e),
          (t = o.getParent(i.getNode(), 'ol,ul')) &&
            ((n = t.parentNode), /^(H[1-6]|P|ADDRESS|PRE)$/.test(n.nodeName) && (m(), o.split(n, t), g()));
      },
  ...
  var hp = Xt.makeMap(
    ...
    vp = function (a) {
      ...
      var r = function (e, t, n, r) {
          var o, i, a;
          if ((!1 === t && (t = f), t))
            for (t = { func: t }, r && Xt.extend(t, r), a = (i = e.toLowerCase().split(' ')).length; a--; )
    ...
    $p = function (e, t, n, r) {
      var o,
        ...
        v = Xt.extend(
          ...
          m && Hp(g, 'mobile') && !p
            ? ((c = 'mobile'), (l = jp), (f = h.sections()), (d = f.hasOwnProperty(c) ? f[c] : {}), Xt.extend({}, l, d))
            : {}),
          {
            validate: !0,
  ...
  function Qp(i) {
    var a = {},
      ...
      s = function (e, t, n, r) {
        var o;
        return (
          ((o = Xt.map(Yp(e, '>'), u))[o.length - 1] = Xt.extend(o[o.length - 1], { func: n, scope: r || i })),
  ...
  var Zp = function (e) {
    ...
    th = function (t, e) {
      return ((n = e), n.collapsed ? _.from(eu(n.startContainer, n.startOffset)).map(ar.fromDom) : _.none()).bind(
        function (e) {
    ...
    ph = function (e, t, n) {
      var r,
        ...
        h =
          ...
          { x: a - (o ? s.left + i.dom().clientLeft + gh(i) : 0), y: u - (o ? s.top + i.dom().clientTop + mh(i) : 0) });
  ...
  function qh(u) {
    var n,
      ...
      y = function (e, t) {
        l.removeByUri(e.src),
          h(e.src, t),
          u.$(e).attr({ src: Bl(u) ? t + '?' + new Date().getTime() : t, 'data-mce-src': u.convertURL(t, 'src') });
      },
      b = function (n) {
        return (
  ...
  var $h = function (e, t) {
    ...
    Jh = function (o, e) {
      return ru(
        ...
        (a = i.startContainer),
        (u = i.startOffset),
        jo.isText(a) ? (0 === u ? _.some(ar.fromDom(a)) : _.none()) : _.from(a.childNodes[u]).map(ar.fromDom)),
        ((t = e),
        (n = t.endContainer),
        (r = t.endOffset),
        jo.isText(n)
      ...
      var p,
        ...
        c = function (e) {
          var t = g.schema.getShortEndedElements(),
            ...
            a = e.endOffset;
          return (
            br(t, r.nodeName.toLowerCase()) ? (0 === o ? n.setStartBefore(r) : n.setStartAfter(r)) : n.setStart(r, o),
            br(t, i.nodeName.toLowerCase()) ? (0 === a ? n.setEndBefore(i) : n.setEndAfter(i)) : n.setEnd(i, a),
            n
          );
        },
        l = function (e, t) {
        ...
        f = function () {
          p && (p.removeAttribute('data-mce-selected'), oa(ar.fromDom(g.getBody()), '#' + h).each(Ui), (p = null)),
          ...
          ((function () {
            g.on('mouseup', function (e) {
              ...
              g.on('click', function (e) {
                var t;
                (t = Ov(g, e.target)) &&
                  (Dv(t) && (e.preventDefault(), g.focus()), Rv(t) && g.dom.isChildOf(t, g.selection.getNode()) && f());
              }),
          ...
          if ((R < t.index && H(B(e.substr(R, t.index - R))), (n = t[6])))
            ...
            if (!p || (l = U.getElementRule(n))) {
              if (
                ...
                (v = t[8])
                  ? ((m = -1 !== v.indexOf('data-mce-type')) && u && (f = !1), ((d = []).map = {}), v.replace(T, F))
                  : ((d = []).map = {}),
                p && !m)
              ) {
                if (
                ...
                if (x)
                  for (o = x.length; o--; )
                    (a = (h = x[o]).name) in d.map ||
                      ('{$uid}' === (_ = h.value) && (_ = 'mce_' + O++), (d.map[a] = _), d.push({ name: a, value: _ }));
                if (C) {
  ...
  var Mv = Fv,
    ...
    ty = function (e, t, n) {
      'fragmented' === t.type ? Xv(t.fragments, e.getBody()) : e.setContent(t.content, { format: 'raw' }),
    ...
    return (
      ...
      (o = {
        ...
        extra: function (e, t) {
          var n, r;
          o.transact(e) &&
            ((r = l[c].bookmark), (n = l[c - 1]), ty(u, n, !0), o.transact(t) && (l[c - 1].beforeBookmark = r));
        },
      })
    );
  }
  ...
  var cy = function (e, t) {
    ...
    gy = function (e, t, n) {
      ...
      return (
        ...
        jo.isElement(r) && ((i = r.childNodes.length - 1), !n && o && o--, (r = r.childNodes[i < o ? i : o])),
        ...
        for (
          fy(n.styles, function (e, t) {
            ...
            fy(n.attributes, function (e, t) {
              var n;
              if (
                ((e = wc.replaceVars(e, r)), 'number' == typeof t && ((t = e), (i = 0)), !i || dy(b.getAttrib(i, t), e))
              ) {
                if (
                  'class' === t &&
                  (e = b.getAttrib(o, t)) &&
        ...
        ? ((d = e),
          ...
          g.block &&
            (y
              ...
              : v.isBlock(m) &&
                !v.isBlock(h) &&
                (vy(v, m, !1) || vy(v, m.firstChild, !0, 1) || m.insertBefore(v.create('br'), m.firstChild),
            ...
            fy(e, function (e) {
              g(e),
                jo.isElement(e) &&
                  ...
                  yy(s, { deep: !1, exact: !0, inline: 'span', styles: { textDecoration: 'underline' } }, null, e);
            });
          });
        };
    ...
    Oy = function (e, t, n, r) {
      t.styles &&
        ...
        Sy(r, Ty(e, 'fontSize'), ky(e, 'backgroundColor', wc.replaceVars(t.styles.backgroundColor, n)));
    },
    By = function (e, t, n, r) {
    ...
    Py = function (e, t, n, r) {
      r &&
        !1 !== t.merge_siblings &&
        ((r = Ey(e, wc.getNonWhiteSpaceSibling(r), r)), (r = Ey(e, r, wc.getNonWhiteSpaceSibling(r, !0))));
    },
    ...
    Fy = function (g, p, h, r) {
              ...
              var a,
                u = function (e) {
                  ...
                  if (y.wrapper && Mm.matchNode(g, e, p, h)) a = 0;
                    ...
                    if (m && !r && y.block && !y.wrapper && wc.isTextBlock(g, t) && wc.isValid(g, n, l))
      ...
      if ('false' !== i.getContentEditable(n.getNode())) {
        if (y) {
          if (r)
            r.nodeType
              ? C(v, r) || ((t = i.createRng()).setStartBefore(r), t.setEndAfter(r), a(i, Pc(g, t, v), 0, !0))
              : a(i, r, 0, !0);
            ...
            g.settings.forced_root_block || !v[0].defaultBlock || i.getParent(u, i.isBlock) || Fy(g, v[0].defaultBlock),
    ...
    qy = function (e, t) {
      var n,
        ...
        p = function (n, e, t) {
          ...
          if (
            ...
            (i = !(!(l = c && c.parentsRequired) || !l.length) && (u && -1 !== Xt.inArray(l, u) ? u : l[0])))
          )
      ...
      return e && e.length
        ? ((o = e[0]), (n = g(o)), (r = Hy.create('div')).appendChild(p(n, e.slice(1), o.siblings)), r)
        : '';
    },
    $y = function (e) {
      var t,
            ...
            if (
              !(
                ('background-color' === e &&
                  ...
                  ((t = Hy.getStyle(n.getBody(), e, !0)), '#ffffff' === Hy.toHex(t).toLowerCase())) ||
          ...
          t = Mv(
            {
              ...
              start: function (e, t, n) {
                ...
                if ((n = h ? k.getElementRule(e) : {})) {
                  ...
                  if (
                    (f && y[e] && (f = !1), n.removeEmpty && db(k, g, y, d) && !d.attributes.map.name && !d.attr('id'))
                  )
                        ...
                        if (m[n.name] && 'li' === n.parent.name) {
                          ...
                          if (r && 1 < o.length) {
                            for (o.reverse(), i = a = O(o[0].clone()), c = 0; c < o.length - 1; c++) {
                              for (
                                k.isValidChild(a.name, o[c].name) ? ((u = O(o[c].clone())), a.append(u)) : (u = a),
                                  s = o[c].firstChild;
                                s && s !== o[c + 1];
                            ...
                            db(k, l, f, i) ? r.insert(n, o[0], !0) : (r.insert(i, o[0], !0), r.insert(n, i)),
                              (r = o[0]),
                  ...
                  for (; n; )
                    (e = n.next),
                      3 === n.type || (1 === n.type && 'p' !== n.name && !l[n.name] && !n.attr('data-mce-type'))
                        ? (t || ((t = N(v, 1)).attr(T.forced_root_block_attrs), S.insert(t, n)), t.append(n))
                        : (r(t), (t = null)),
                      (n = e);
                  r(t);
                }
  ...
  var Tb,
    ...
    Db = function (r, a) {
      ...
      var R = function (e) {
        ...
        n = function (e) {
          ...
          (t = e),
            (n = a.selection.getRng()),
            !R(t.target) || yv(t.clientX, t.clientY, n) || e.isDefaultPrevented() || a.selection.select(r);
        },
        D = function (e) {
        ...
        O = function (e) {
          ...
          return (
            ...
            'false' !== e.getAttribute('data-mce-resize') && e !== a.getBody() && Lr(ar.fromDom(e), t))
          );
        },
        B = function (e) {
          var t, n, r, o;
          (t = e.screenX - d),
            ...
            (t = A.scrollWidth - x) + (n = A.scrollHeight - w) != 0 && N.setStyles(c, { left: r - t, top: o - n }),
            i || (Tp(a, u, h, v), (i = !0));
        },
        P = function () {
          i = !1;
    ...
    jb = function (e, t) {
      for (var n = e.rows(), r = 0; r < n.length; r++)
        for (var o = n[r].cells(), i = 0; i < o.length; i++) if (Mr(o[i], t)) return _.some(Mb(i, r));
      return _.none();
    },
    ...
    Qb = function (e, t) {
      ...
      var n,
        ...
        l =
          ...
          (s = Pb(n, gm(u))),
          (o = r.contextual ? Jb(ar.fromDom(n.getBody()), s).dom() : i.cloneContents()) && a.appendChild(o),
            ...
            return (
              ...
              _.from(n).map(function (e) {
                var t = r.nodeIndex(e),
                  n = r.createRng();
                return (
                  n.setStart(e.parentNode, t), n.setEnd(e.parentNode, t + 1), o && (Qh(r, n, e, !0), Qh(r, n, e, !1)), n
                );
              })).each(i),
              e
            );
          ...
          getSelectedBlocks: function (e, t) {
            return (function (e, t, n, r) {
              ...
              if (
                ...
                for (var u = new go((o = n), i); (o = u.next()) && o !== r; ) e.isBlock(o) && a.push(o);
        ...
        !1 === e.isDefaultPrevented() &&
          ...
          XC(
            [
              ...
              { keyCode: rv.RIGHT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: Xd.moveNextWord(t, n) },
              { keyCode: rv.LEFT, ctrlKey: !o.isOSX(), altKey: o.isOSX(), action: Xd.movePrevWord(t, n) },
    ...
    px = function (a, e) {
      var t,
        ...
        S = function (e) {
          ...
          if (((r = t = e || 'TABLE' === f || 'HR' === f ? x.create(e || m) : c.cloneNode(!1)), !1 === kl(a)))
        ...
        T = function (e) {
          ...
          for (
            t = new go(s, c), jo.isText(s) && (e && 0 === o ? t.prev() : e || o !== s.nodeValue.length || t.next());
            (n = t.current());
          ...
          (((m && !n) || (!m && n)) &&
            (s = (function (e, t, n, r, o) {
              ...
              if (!(a = m.getParent(r, m.isBlock)) || !lx(m, a)) {
                if (
                  ((l =
                    (a = a || g) === e.getBody() || ((f = a) && /^(TD|TH|CAPTION)$/.test(f.nodeName))
                      ? a.nodeName.toLowerCase()
                      : a.parentNode.nodeName.toLowerCase()),
                  !a.hasChildNodes())
                )
                  return (i = m.create(d)), gx(e, i), a.appendChild(i), n.setStart(i, 0), n.setEnd(i, 0), i;
          ...
          if (!v(e)) {
            var t =
              (i = e).dataTransfer && (a = i.dataTransfer.getData(p)) && 0 <= a.indexOf(g)
                ? ((a = a.substr(g.length).split(',')), { id: unescape(a[0]), html: unescape(a[1]) })
                : null;
            if (t && t.id !== u.id) {
              e.preventDefault();
  ...
  var gw = function (e) {
    ...
    bw = function (t, e) {
      ...
      f.inline || (t.getElement().style.visibility = t.orgVisibility),
        ...
        t.readonly ||
          (t.inline && 'static' === vw.getStyle(n, 'position', !0) && (n.style.position = 'relative'),
        ...
        (t.parser =
          ((o = bb((u = t).settings, u.schema)).addAttributeFilter('src,href,style,tabindex', function (e, t) {
    ...
    xw = function (e, t) {
      ...
      return (
        ...
        (e.iframeHTML =
          ((g = vl((f = e)) + '<html><head>'),
          yl(f) !== f.documentBaseUrl && (g += '<base href="' + f.documentBaseURI.getURI() + '" />'),
    ...
    ww = function (e, t) {
      var n = xw(e, t);
      t.editorContainer &&
        ((Cw.get(t.editorContainer).style.display = e.orgDisplay), (e.hidden = Cw.isHidden(t.editorContainer))),
    ...
    Aw = function (t) {
      ...
      return (
        ...
        (u.aria_label = u.aria_label || Nw.getAttrib(s, 'aria-label', t.getLang('aria.rich_text_area'))),
        ...
        S(o)
          ? ((n.settings.theme = Sw(o)),
            ...
            n.theme.init && n.theme.init(n, Ah.urls[o] || n.documentBaseUrl.replace(/\/$/, ''), n.$))
          : (n.theme = {}),
        (i = t),
        (a = []),
        ...
        if (t.getElement() && fe.contentEditable) {
          ...
          o &&
            ...
            e.hidden_input &&
              ...
              (Rw.insertAfter(Rw.create('input', { type: 'hidden', name: n }), n), (t.hasHiddenInput = !0)),
    ...
    zw = function (r, e) {
      var t,
        n,
        o = this;
      if (((r = Lw(r)), (t = (e = o.settings = e || {}).base_uri), /^([\w\-]+):([^\/]{2})/i.test(r) || /^\s*#/.test(r)))
        o.source = r;
      else {
        var i = 0 === r.indexOf('//');
  ...
  (zw.prototype = {
    ...
    toRelative: function (e) {
      ...
      if ('./' === e) return e;
      if (
        ('mce_host' !== (e = new zw(e, { base_uri: this })).host && this.host !== e.host && e.host) ||
        this.port !== e.port ||
  ...
  Jw(
    (tN.prototype = {
      ...
      show: function () {
        this.hidden &&
          ((this.hidden = !1),
          this.inline ? (this.getBody().contentEditable = !0) : (Gw.show(this.getContainer()), Gw.hide(this.id)),
          this.load(),
          this.fire('show'));
      },
      hide: function () {
              ...
              r.types
                ...
                : (Xt.each(o, function (e) {
                    ...
                    (t = s.get(e.id)) &&
                      ...
                      (EN(t), t.unbindAllNativeEvents(), t.destroy(!0), (t.removed = !0), (t = null));
                  }),
                  0 ===
                    ...
                    : hN(o, function (e) {
                        ...
                        (t = e),
                          r.inline && t.tagName.toLowerCase() in u
                            ? kh.initError('Could not initialize inline editor on invalid inline target element', e)
                            : n(c(e), r, e);
                      }));
          };
        return (
  ...
  var _N,
    ...
    LN = {
      ...
      findBestRelativePosition: function (e, t, n, r) {
        ...
        for (i = 0; i < r.length; i++)
          if ((o = PN(e, t, r[i])).x >= n.x && o.x + o.w <= n.w + n.x && o.y >= n.y && o.y + o.h <= n.h + n.y)
            return r[i];
        return null;
      },
    ...
    MN = {
      ...
      create: function (e, t) {
        var n;
        if (('string' == typeof e ? ((t = t || {}).type = e) : (e = (t = e).type), (e = e.toLowerCase()), !(n = FN[e])))
  ...
  var VN = Math.min,
    ...
    $N = function (e, n) {
      ...
      if ('object' === t) {
        ...
        for (i in ((o = '{'), e))
          e.hasOwnProperty(i) &&
            (o += 'function' != typeof e[i] ? (1 < o.length ? ',' + n : n) + i + n + ':' + $N(e[i], n) : '');
        return o + '}';
      }
      return '' + e;
    },
