...
export const Template = ({ items }) => `<div class="utrecht-navhtml">
   <nav class="utrecht-sidenav">
    <ul class="utrecht-sidenav__list">${items
      .map(
        ({ href, title, current, focus, children, shiblings }) => `<li class="utrecht-sidenav__item">
          <a class="${clsx(
          ...
          siblings
            ? siblings
                .map(
                  ({ href, title, current, focus }) =>
                    `<li class="utrecht-sidenav__item utrecht-sidenav__item--sibling"><a class="${clsx(
                      "utrecht-sidenav__link utrecht-sidenav__link--sibling",
                      current && "utrecht-sidenav__link--current utrecht-sidenav__link--sibling--current",
                      focus && "utrecht-sidenav__link--focus"
                    )}" href="${href}">${title}</a></li>`
                )
                .join("")
...
<Canvas>
  <Story
    ...
    args={{
      siblings: [
        { href: "#", title: "sibling 1" },
        { href: "#", title: "sibling 2" },
      ],
      items: [
        { href: "#", title: "Crumb #1" },
        { href: "#", title: "Crumb #2" },
        { href: "#", title: "Crumb #3" },
        {
          ...
          title: "Crumb #4",
          children: [
            { href: "#", title: "Child 1", current: true },
            { href: "#", title: "Child 2" },
            { href: "#", title: "Child 3" },
          ],
        },
