...
<Meta id="css-mark--tokens" title="CSS Component/Mark/Design Tokens" />

## Design Tokens

<ComponentTokensSection tokens={tokens} definition={tokensDefinition} component="utrecht-mark"></ComponentTokensSection>
