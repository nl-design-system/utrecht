...
See for more information: [`theme-color` on MDN](https://developer.mozilla.org/en-US/docs/Web/HTML/Element/meta/name/theme-color) and look for browser support status on [Can I use ...?](https://caniuse.com/meta-theme-color)
