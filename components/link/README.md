...
Als de `visited` een ander visueel ontwerp heeft dan een normale link, dan kunnen anderen zien welke pagina's zijn bekeken. Gebruik daarom liever geen `visited` design tokens voor websites waar de privacy van de gebruiker in gevaar komt. De privacy komt in gevaar wanneer andere personen dezelfde browser gebruiken, wanneer mensen meekijken of wanneer je een screenshot deelt.
