...
- De tekst die je in het slot mee geeft laat je terug komen in het label die bij de input hoort. Voorbeeld: je geeft "mL per uur" mee aan het `end` slot, en je geeft "Verbruik in mL per uur" mee in het primaire `label`. De "mL per uur" in het slot word niet voorgelezen door screen readers, maar komt terug in het `label` en is dus nog steeds toegankelijk.
