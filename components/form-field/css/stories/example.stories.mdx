...
<Canvas>
  <Story
    ...
    args={{
      ...
      label: "Bericht",
      required: true,
      statusDescription: "Uw bericht heeft nog ruimte voor 30 karakters.",
      id: "3d34bb1d-0cfa-4b69-aa29-2ae1ad53cd8d",
    }}
    parameters={{
      chromatic: { disableSnapshot: true },
    }}
...
<Canvas>
  <Story
    name="Bericht dat te lang is"
    args={{
      control: "textarea",
      label: "Bericht",
      required: true,
      invalid: true,
      invalidDescriptionLive: "Fout: uw bericht 42 tekens te veel. Maak het bericht korter.",
      statusDescription: "Uw bericht 42 tekens te veel.",
      id: "354f8815-26d5-4347-a03a-0cd6d3ea2bc8",
    }}
    parameters={{
      chromatic: { disableSnapshot: true },
    }}
...
<ArgsTable story="Bericht dat te lang is" />
