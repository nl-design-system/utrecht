...
`,`
`,n(i,{children:d})]})}function c(e={}){const{wrapper:o}=Object.assign({},l(),e.components);return o?n(o,{...e,children:n(r,{...e})}):r()}const m=()=>{throw new Error("Docs-only story")};m.parameters={docsOnly:!0};const t={title:"React Component/Developing components",id:"react--contributing",tags:["stories-mdx"],includeStories:["__page"]};t.parameters=t.parameters||{};t.parameters.docs={...t.parameters.docs||{},page:c};const k=["__page"];export{k as __namedExportsOrder,m as __page,t as default};
//# sourceMappingURL=contributing.stories-90f6ac8c.js.map
